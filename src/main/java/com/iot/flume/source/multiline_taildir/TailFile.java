...
package com.iot.flume.source.multiline_taildir;
...
import static com.iot.flume.source.taildir.TaildirSourceConfigurationConstants.BYTE_OFFSET_HEADER_KEY;
...
public class TailFile {
    ...
    public TailFile(File file, Map<String, String> headers, long inode, long pos, String regex)
            throws IOException {
    ...
    private Event readEvent(boolean backoffWithoutNL, boolean addByteOffset) throws IOException {
        ...
        while (true) {
            ...
            String str = new String(line.line);
